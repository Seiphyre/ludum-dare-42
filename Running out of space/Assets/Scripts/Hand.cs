...
public class Hand : MonoBehaviour
{
    ...
    public void TakeObject(ItemEntity entity)
    {
		...
		SoundManager.GetInstance().PlaySound(SoundManager.GetInstance().TakeObjectSound);
    ...
    public void ReleaseObject()
    {
        ...
        if (canBeRelease == true)
        {
            ...
            CurrentObject = null;
			SoundManager.GetInstance().PlaySound(SoundManager.GetInstance().ReleaseObjectSound);
